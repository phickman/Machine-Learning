...
% In the exercise example, there are 10 rows, of 401 elements each
% all_theta is the returned value
...
% Logical arrays which contain binary (0 or 1) elements
